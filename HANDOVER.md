...
6. 課金導入時: 会話ログ閲覧の有料ゲート（D-11）とStoreKit/RevenueCatのentitlement接続

## 次に進める順番

1. 規約・プライバシー・サポート文面を作る
2. iOS化と課金を実装する（entitlementはD-08のスタブに接続、閲覧境界はD-11、バックアップはD-09第二段階へ）
3. 実機QA後にApp Store提出準備へ進む
